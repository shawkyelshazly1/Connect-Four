...
class Game(object):
    ...
    def init_Start_game_window(self):
        ...
        Label(self.start_window_canvas,
              text='Red', font=('Helvetica', 30, BOLD), background='#a7e6e8', fg='red').place(relx=0.55, rely=0.4, anchor=CENTER, y=70, x=50)

        Label(self.start_window_canvas,
              text='Player2:', font=('Helvetica', 30), background='#a7e6e8').place(relx=0.5, rely=0.4, anchor=CENTER, y=125, x=-50)

        Label(self.start_window_canvas,
              text='Blue', font=('Helvetica', 30, BOLD), background='#a7e6e8', fg='blue').place(relx=0.55, rely=0.4, anchor=CENTER, y=125, x=50)
